...
import org.systemsbiology.addama.workspaces.fs.callbacks.JdbcTemplateJsonConfigHandler;
 ...
 * @author hrovira
 */
public abstract class BaseDsController extends BaseController {
    protected final Map<String, JdbcTemplate> jdbcTemplatesByUri = new HashMap<String, JdbcTemplate>();

    public void afterPropertiesSet() throws Exception {
        super.afterPropertiesSet();
        jsonConfig.processConfiguration(new JdbcTemplateJsonConfigHandler(jdbcTemplatesByUri));
    }
