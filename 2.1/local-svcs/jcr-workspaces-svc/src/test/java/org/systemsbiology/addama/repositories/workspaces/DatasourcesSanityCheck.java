package org.systemsbiology.addama.repositories.workspaces;/*
 ...
 * @author hrovira
 */
public class DatasourcesSanityCheck {
    private static final String URI = "/addama/repositories/workspaces/hrovira@gmail.com/TestTest";
    ...
    public static void main(String[] args) throws Exception {
        ...
        doPost(URI, new File("/local/temp/rest/track.tsv"));
        doPost(URI + "/datasources", new File("/local/temp/rest/track.json"));
    }
