 ...
 * @author hrovira
 */
public class JcrTemplateJsonConfigHandler extends GenericMapJsonConfigHandler<JcrTemplate> {
    public JcrTemplateJsonConfigHandler(Map<String, JcrTemplate> map) {
        super(map);
    }

    @Override
    public JcrTemplate getSpecific(JSONObject item) throws Exception {
