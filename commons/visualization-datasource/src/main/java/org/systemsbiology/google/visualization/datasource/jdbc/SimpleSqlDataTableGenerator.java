...
import static com.google.visualization.datasource.Capabilities.SQL;

/**
 * @author hrovira
 */
public class SimpleSqlDataTableGenerator implements DataTableGenerator {
    private static final Logger log = Logger.getLogger(SimpleSqlDataTableGenerator.class.getName());

    private final JdbcTemplate jdbcTemplate;
    private final String tableName;

    public SimpleSqlDataTableGenerator(JdbcTemplate jdbcTemplate, String tableName) {
