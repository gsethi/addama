### Internally developed software is offered with the following copyright and license: ###
...
```
        ...
        2.0 License for further details.
 
        You should have received a copy of the Apache License version 2.0 along
        with this library; if not please visit http://www.apache.org/licenses/LICENSE-2.0.
```
